              ...
              <div className="space-y-6">
                ...
                {codingBlocked ? (
                  <p className="mt-4 rounded-xl border border-amber-500/30 bg-amber-500/10 px-4 py-3 text-sm text-amber-200">
                    Daily coding interview limit reached. {formatResetsLabel(usageStatus?.codingInterview?.resetsAt)}
                  </p>
                ) : null}
                <button
                  type="button"
                  ...
                  className="mt-6 w-full rounded-xl bg-indigo-600 px-6 py-3.5 font-semibold text-white hover:bg-indigo-500 hover:shadow-lg hover:shadow-indigo-500/20 flex items-center justify-center gap-2 transition-all disabled:opacity-45 disabled:cursor-not-allowed disabled:hover:bg-indigo-600"
                >
