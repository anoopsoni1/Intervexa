...
export default function About() {
  return (
    <>
      <SEO
        title="About Ansoyal AI"
        description="Learn about Ansoyal AI and our mission to help job seekers create ATS-optimized resumes and prepare for interviews."
        image="/og-about.png"
        url="https://intervexa.co-vid.in/about"
        keywords="About Ansoyal AI, AI career platform, ATS resume mission"
      />
            ...
            <div className="w-full max-w-5xl mx-auto">
              ...
              >
                ...
                <h1 className="text-4xl sm:text-5xl md:text-6xl font-bold text-white tracking-tight">
                  About <span className="bg-linear-to-r from-amber-400 to-orange-500 bg-clip-text text-transparent">Ansoyal AI</span>
                </h1>
              ...
              >
                ...
                <p className="text-slate-400 text-sm sm:text-base leading-relaxed max-w-3xl">
                  Ansoyal AI was built to level the playing field. Applicant tracking
