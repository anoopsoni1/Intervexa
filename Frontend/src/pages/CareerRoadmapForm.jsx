...
export default function CareerRoadmapForm({ onSubmit, loading, limitDisabled }) {
  ...
  return (
    ...
    >
      ...
      <button
        type="submit"
        disabled={loading || !careerGoal.trim() || limitDisabled}
      ...
      >
        {loading ? "Generating roadmap…" : limitDisabled ? "Daily limit reached" : "Generate Roadmap"}
      </button>
    </form>
  );
}
